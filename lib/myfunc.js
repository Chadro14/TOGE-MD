...
exports.totalcase = () => {
   var file = fs.readFileSync("../TOGE-MD.js").toString()
...
exports.buffergif = async (image) => {
	...
	const filename = `${Math.random().toString(36)}`
			await fs.writeFileSync(`./TogeMedia/trash/${filename}.gif`, image)
					 child_process.exec(
								`ffmpeg -i ./XeonMedia/trash/${filename}.gif -movflags faststart -pix_fmt yuv420p -vf "scale=trunc(iw/2)*2:trunc(ih/2)*2" ./TogeMedia/trash/${filename}.mp4`
										) 
  await sleepy(4000)
